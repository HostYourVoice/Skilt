...
////            self.questions = await self.generateQuestionsFromJSON()
...
//        guard let module = CourseStore.shared.getModule(byId: moduleId) else {
//            print("Module not found")
//            return
//        }
//        
//        // Create a question from the module's scenario
//        let question = ModuleQuestion(
//            id: UUID(),
//            title: module.title,
//            scenario: module.scenario.context,
//            question: module.scenario.requirements.joined(separator: "\n"),
//            options: [], // No options for free-text submissions
//            correctAnswer: 0,
//            explanation: "",
//            difficulty: module.difficulty.score,
//            averageScorePercentage: 0.0,
//            totalSubmissions: 0,
//            points: module.difficulty.baseCompletionPoints,
//            altRow: false,
//            rubricPoints: [:],
//            checklistItems: module.rubric.checklistItems.map { ChecklistItem(id: $0.id, description: $0.description) },
//            aiFeedbackPoints: module.rubric.aiFeedbackPoints
//        )
//        
//        self.questions = [question]
//    }
//    
//    func submitAnswer(_ answer: String, for question: ModuleQuestion) {
//        // Calculate score based on rubric and checklist items
//        let score = calculateScore(answer: answer, question: question)
//        
//        // Update question statistics
//        if let index = questions.firstIndex(where: { $0.id == question.id }) {
//            var updatedQuestion = questions[index]
//            updatedQuestion.totalSubmissions += 1
//            updatedQuestion.averageScorePercentage = calculateNewAverageScore(
//                currentAverage: updatedQuestion.averageScorePercentage,
//                totalSubmissions: updatedQuestion.totalSubmissions,
//                newScore: score,
//                totalPoints: updatedQuestion.points
//            )
//            
//            // Update difficulty based on performance
//            updatedQuestion.difficulty = calculateNewDifficulty(
//                currentDifficulty: updatedQuestion.difficulty,
//                scorePercentage: updatedQuestion.averageScorePercentage
//            )
//            
//            questions[index] = updatedQuestion
//            
//            // Update module difficulty in CourseStore
//            Task {
//                await CourseStore.shared.updateModuleDifficulty(
//                    moduleId: moduleId,
//                    newDifficulty: updatedQuestion.difficulty
//                )
//            }
//        }
//    }
//    
//    private func calculateScore(answer: String, question: ModuleQuestion) -> Int {
//        var score = 0
//        
//        // Check against checklist items
//        for item in question.checklistItems {
//            if answer.contains(item.description) {
//                score += 1
//            }
//        }
//        
...
//    }
//    
//    private func calculateNewAverageScore(
//        currentAverage: Double,
//        totalSubmissions: Int,
//        newScore: Int,
//        totalPoints: Int
//    ) -> Double {
//        let currentTotal = currentAverage * Double(totalSubmissions)
//        let newScorePercentage = Double(newScore) / Double(totalPoints)
//        return (currentTotal + newScorePercentage) / Double(totalSubmissions + 1)
//    }
//    
//    private func calculateNewDifficulty(currentDifficulty: Int, scorePercentage: Double) -> Int {
//        if scorePercentage >= 0.8 {
//            return min(currentDifficulty + 1, 5)
